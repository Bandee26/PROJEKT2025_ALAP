...
-- Script date 2025. 03. 25. 8:44:52
...
CREATE TABLE motorspecifikaciok (
  ...
  Motortipus_azonosito INT DEFAULT NULL,
...
CREATE TABLE foglalas (
  ...
  fizmod VARCHAR(30) NOT NULL DEFAULT '-',
  fizetett VARCHAR(40) NOT NULL DEFAULT '-',
  PRIMARY KEY (id)
)
ENGINE = INNODB,
AUTO_INCREMENT = 42,
...
(43, 'Bandi', '303030', 'bandi@gmail.com', '893b95a698ff9bca2806a9bbb04d1d713d33ca45ced817ab1cfa8a38b04bce92', '["QSTU-245", "ZEGT-780", "ACVQ-424", "ZYHV-660", "ONEP-577", "CJRR-818"]'),
...
(38, '2025-03-18 09:51:50', 'YCFW-444,ZEGT-780', 43, '-', '-'),
(39, '2025-03-18 09:51:59', 'ZEGT-780', 43, '-', '-'),
(40, '2025-03-18 14:08:21', 'ZYHV-660', 43, '-', '-'),
(41, '2025-03-21 10:36:58', 'CJRR-818', 43, '-', '-');
...
(53, 'AAAA-111', NULL, NULL, NULL, 2009, '200000', NULL, NULL, NULL, NULL, 1000000, NULL);
