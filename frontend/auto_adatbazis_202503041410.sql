...
-- Script date 2025. 03. 04. 14:10:12
...
-- Drop view `audi`
--
DROP VIEW IF EXISTS audi CASCADE;
...
-- Drop view `bmw`
--
DROP VIEW IF EXISTS bmw CASCADE;

--
-- Drop view `ford`
--
DROP VIEW IF EXISTS ford CASCADE;

--
-- Drop view `hasznal_szuro`
--
DROP VIEW IF EXISTS hasznal_szuro CASCADE;
...
-- Drop view `toyota`
--
DROP VIEW IF EXISTS toyota CASCADE;

--
-- Drop view `volkswagen`
--
DROP VIEW IF EXISTS volkswagen CASCADE;
...
--
-- Drop view `marka_modellek`
--
DROP VIEW IF EXISTS marka_modellek CASCADE;
...
CREATE TABLE modellek (
  ...
  Marka_azonosito INT DEFAULT NULL,
...
AS
SELECT
  `m`.`Marka_ID` AS `marka_id`,
  `m`.`Marka` AS `marka_nev`,
  (SELECT
      GROUP_CONCAT(`md`.`Modell` ORDER BY `md`.`Modell_ID` ASC SEPARATOR ', ')
    FROM `modellek` `md`
    WHERE (`md`.`Marka_azonosito` = `m`.`Marka_ID`)) AS `modellek`
FROM `markak` `m`;
...
(3, 'asdf', 'asdf@gmail.com', 'asdf', 1);

-- 
-- Dumping data for table autok
--
INSERT INTO autok VALUES
(1, 'ONEP-577', 3, 7, 8, 2012, '294038', 1, 1, 1, 2, 8880203, 20),
(2, 'CJRR-818', 3, 8, 9, 2020, '193550', 2, 4, 1, 1, 84360459, 9),
(3, 'BFSJ-549', 1, 7, 2, 2011, '245741', 1, 1, 2, 1, 57064519, 14),
(4, 'ACVQ-424', 3, 2, 9, 2011, '156005', 1, 2, 3, 1, 84410641, 19),
(5, 'ZYHV-660', 4, 3, 10, 2001, '73855', 4, 8, 1, 1, 15879696, 1),
(6, 'MPUT-129', 3, 7, 7, 2015, '66851', 4, 8, 2, 1, 66730580, 11),
(7, 'QSTU-245', 2, 8, 4, 2022, '175554', 4, 7, 2, 1, 13882929, 11),
(8, 'UALV-477', 1, 10, 2, 2013, '75874', 3, 5, 3, 2, 19283328, 2),
(9, 'YCFW-444', 2, 2, 6, 2012, '259704', 4, 7, 3, 1, 79475779, 5),
(10, 'RGHI-479', 3, 2, 9, 2011, '274426', 2, 4, 3, 1, 40679224, 3),
(11, 'XXBG-478', 4, 8, 11, 2021, '104484', 3, 5, 1, 1, 83184084, 10),
(12, 'EKCZ-702', 2, 3, 6, 2015, '157309', 3, 5, 1, 2, 6362636, 19),
(13, 'ZEGT-780', 3, 3, 8, 2002, '238356', 3, 5, 3, 1, 34928059, 14),
(14, 'GWGS-413', 4, 9, 11, 2016, '117892', 4, 7, 3, 2, 38016227, 2),
(15, 'GJSN-373', 3, 1, 9, 2018, '47311', 2, 4, 3, 1, 30045135, 13),
(16, 'DZOT-890', 5, 10, 14, 2011, '265215', 3, 6, 3, 2, 79400446, 11),
(17, 'JUHV-727', 4, 9, 10, 2011, '110205', 4, 7, 1, 1, 85476853, 5),
(18, 'ODSD-634', 5, 1, 14, 2003, '110714', 3, 6, 2, 1, 64647995, 11),
(19, 'OYLM-498', 3, 9, 7, 2001, '31008', 2, 4, 2, 1, 63362310, 13),
(20, 'GJBZ-032', 3, 1, 7, 2016, '171651', 1, 1, 1, 2, 10660660, 14),
(21, 'ZBSK-276', 2, 10, 4, 2013, '179540', 4, 7, 3, 2, 99326134, 19),
(22, 'ZLKU-028', 3, 3, 8, 2019, '157647', 4, 7, 3, 1, 74103773, 14),
(23, 'RIVA-711', 2, 6, 6, 2018, '206719', 1, 1, 1, 2, 59775541, 11),
(24, 'VYQO-163', 1, 10, 2, 2012, '273951', 1, 2, 1, 2, 83980148, 8),
(25, 'AQHZ-673', 3, 2, 8, 2008, '41576', 1, 1, 1, 1, 44146959, 8),
...
(29, 'GJXJ-238', 1, 3, 2, 2013, '255386', 4, 8, 1, 1, 29373775, 3),
(30, 'ZKFB-988', 4, 2, 12, 2021, '108063', 3, 6, 2, 2, 2949709, 3),
(31, 'XVQV-905', 3, 3, 8, 2019, '241814', 4, 7, 2, 1, 94578454, 18),
(32, 'JYJL-539', 3, 10, 9, 2006, '129029', 1, 2, 1, 1, 22178951, 17),
(33, 'AHPV-762', 3, 4, 7, 2004, '79122', 1, 2, 1, 1, 9844978, 1),
(34, 'CYCN-597', 1, 3, 2, 2010, '30942', 4, 7, 3, 2, 30058285, 20),
(35, 'YZMA-196', 3, 9, 7, 2001, '140610', 4, 8, 3, 2, 30380986, 18),
(36, 'VGSM-190', 2, 8, 5, 2009, '214442', 1, 1, 1, 1, 46588969, 1),
(37, 'VUVU-968', 4, 7, 10, 2009, '287431', 2, 3, 2, 2, 17790506, 3),
(38, 'LEZD-328', 3, 10, 7, 2009, '180224', 2, 4, 1, 1, 77386686, 20),
(39, 'JHHM-901', 2, 10, 6, 2012, '121930', 2, 3, 3, 1, 43052111, 4),
(40, 'YWWG-178', 5, 10, 13, 2010, '194656', 3, 5, 1, 1, 60790923, 10),
(41, 'GJRF-097', 3, 10, 7, 2022, '134589', 2, 4, 3, 2, 84993149, 9),
(42, 'TZHG-410', 3, 3, 9, 2012, '226453', 1, 1, 1, 2, 58910601, 12),
(43, 'UGEL-908', 5, 7, 14, 2001, '19345', 4, 8, 3, 2, 32506562, 8),
(44, 'MCXF-192', 3, 7, 9, 2016, '164105', 3, 6, 2, 1, 2670569, 9),
(45, 'ALBM-034', 3, 9, 7, 2017, '147574', 1, 1, 2, 1, 15943401, 18),
(46, 'XQDV-967', 1, 10, 3, 2006, '50795', 2, 3, 2, 2, 33637903, 8),
(47, 'VROM-921', 4, 7, 12, 2010, '80739', 1, 2, 1, 2, 74330986, 18),
(48, 'HDLO-694', 2, 9, 6, 2005, '66629', 4, 8, 3, 2, 9943449, 8),
(49, 'YVUY-925', 5, 2, 15, 2022, '225164', 4, 7, 2, 2, 89818703, 18),
(50, 'UNYH-593', 5, 9, 14, 2017, '71873', 1, 2, 3, 2, 99629942, 20),
